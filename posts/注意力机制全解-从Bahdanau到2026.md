...
刚接触大模型那会儿，我试着读 DeepSeek 的技术报告，满篇缩写——MLA、GQA、DSA、KDA——每个字母都认识，连起来完全不知所云。后来把这条十年的演进线捋完才发现一个让人踏实的事实：所有这些花活，都是在回答同一个问题——**注意力很强大，但它太贵了**。为了讲清楚"贵在哪、各家怎么省"，得回到最初的地方。
